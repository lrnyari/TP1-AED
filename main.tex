...
\pred{esCuadrada}{matriz: \TLista{\TLista{\ent}}}{\paraTodo[unalinea]{i,j}{\ent}{0 \leq i,j < |matriz| \implicaLuego (|matriz[i]| = |matriz[j]|) \land (|matriz| = |matriz[0]|)}}
...
\begin{proc}{cantidadCaminosNSaltos}{\Inout \textit{conexión} : \TLista{\TLista{\ent}}, \In \textit{n}: \ent}{}
	\requiere{conexion = A0 \land matrizCuadradaYSimetrica(conexion) \land soloUnosyCeros(conexion) }
